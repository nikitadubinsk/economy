...
export const categoriesLoader = createSelector(state, state => state.categoriesLoader);
...
export const childrens = createSelector(state, state => state.childrensInfo.childrens);
export const childrensLoader = createSelector(state, state => state.childrensInfo.loader);
export const childrenStatistics = createSelector(state, state => state.childrensInfo.statistics);
export const childrenLoaderStatistics = createSelector(state, state => state.childrensInfo.loaderStatistics);
export const userInfo = createSelector(state, state => state.userInfo);
export const loaderUserInfo = createSelector(state, state => state.userInfo.loader);